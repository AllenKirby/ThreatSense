      ...
      <div className="w-auto h-auto text-center p-7">
        ...
        <div className='w-full flex items-center justify-center'>
          <form onSubmit={handleSubmit}>
            <input type="file" accept=".exe,.dll" onChange={handleFileChange} />
            <button type='submit' className="text-2xl px-7 py-2 rounded-2xl bg-cyan-950 mt-4 hover:bg-white hover:text-slate-900 hover:scale-125 transition-all duration-150 flex"><FiUpload color='white' className='mr-4'/> Upload File</button>
          </form>
        </div>
      </div>
    </section>
